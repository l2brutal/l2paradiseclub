...
<?php include "script.php"; ?>
               ...
               <div class="col-md-6 cSiege">
                 ...
                 <div class="col-md-8">
                   <h4>Gludio Castle</h4>
                   <p>Próxima siege: <span><?php echo date("d-m H:i:s", strtotime($retorno->sdate)); ?></span></p>
                   <p>Dono: <span><?php echo $retorno->clan_name; ?></span></p>
                 </div>
               </div>
             <?php } ?>
             ...
             <?php while ($retorno = mssql_fetch_object($aden)){ ?>
               <div class="col-md-6 cSiege">
                 ...
                 <div class="col-md-8">
                   <h4>Aden Castle</h4>
                   <p>Próxima siege: <span><?php echo date("d-m H:i:s",$retorno->sdate/1000); ?></span></p>
                   <p>Dono: <span><?php echo $retorno->clan_name; ?></span></p>
                 </div>
               </div>
             <?php } ?>
             ...
             <?php while ($retorno = mssql_fetch_object($schuttgart)){ ?>
               <div class="col-md-6 cSiege">
                 ...
                 <div class="col-md-8">
                   ...
                   <p>Próxima siege: <span><?php echo date("d-m H:i:s", strtotime($retorno->sdate)/1000); ?></span></p>
                   <p>Dono: <span><?php echo $retorno->clan_name; ?></span></p>
                 </div>
               </div>
             <?php } ?>
