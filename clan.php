...
<div class="title-page">CLANS</div>
<div class="subtitle-page">See the clans of our server</div>
...
<table width="100%" cellspacing="0" cellpadding="10">
    <tr>
        ...
        <?php
                      ...
                      $pks = mssql_query("SELECT TOP 30 * FROM Pledge order by siege_kill DESC");

                      $cont1 = 0;
                      while ($retorno = mssql_fetch_object($pks)){
                          $cont1++;
                          echo "<th scope=row>$cont1</th>";
                          echo "<td>".$retorno->name."</td>";
                          echo "<td>".$retorno->skill_level."</td>";
                          echo "<td>".$retorno->siege_kill."</td>";
                          echo "<td>".$retorno->siege_death."</td>";
                          echo "</tr>";
                      }
...
<div style="display: <?php echo $enable_ranking ?> ;" class="separator-content"></div>
