<!-- Global site tag (gtag.js) - Google Analytics --><script async src="https://www.googletagmanager.com/gtag/js?id=UA-119574268-1"></script><script>  window.dataLayer = window.dataLayer || [];  function gtag(){dataLayer.push(arguments);}  gtag('js', new Date());  gtag('config', 'UA-119574268-1');</script><?php
...
<!-- Promo video -->
<iframe width="500" height="315" src="https://www.youtube.com/embed/lcyTD1bu9xw?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
<!-- Promo video end -->
...
<div class="atualstudioCountdown">
	<style>
		...
		#soon-glow { font-family: 'Quicksand', sans-serif; color: white; background: transparent; text-transform:lowercase; }
		#soon-glow .soon-label { color: white; text-shadow:0 0 .25rem rgba(0,0,0,.75); }
		#soon-glow .soon-ring-progress { color: lightgreen; background-color:rgba(0,0,0,.15); }
