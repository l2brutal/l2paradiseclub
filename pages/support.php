...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-119574268-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-119574268-1');
</script>
...
<div class='pddInner'>
	...
	<a style='display:table;margin: 0 auto;' href='http://omassivo.com.br/l2massivo/forum/' class='default dbig'><?php echo $LANG[12088]; ?></a><br />
