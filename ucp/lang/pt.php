...
$LANG[40000] = "<br /><br />A cada ".$coinQntV." de ".$coinName." você será recompensado com um certo valor, descrito abaixo, com bônus automático de ".$buyCoins['bonus_percent'][1]."% para doações acima de ".$buyCoins['bonus_count'][1]." ".$coinName.", ".$buyCoins['bonus_percent'][2]."% para doações acima de ".$buyCoins['bonus_count'][2]." ".$coinName." e ".$buyCoins['bonus_percent'][3]."% para doações acima de ".$buyCoins['bonus_count'][3]." ".$coinName.".";
...
$LANG[40005] = "Suas <b>".$coinName."</b> serão convertidas em <b>".$coinGame."</b> e inseridas em seu inventory, podendo ser utilizadas dentro do jogo para usufruir de vantagens e recursos.";
$LANG[40006] = "Para outra conta";
$LANG[40007] = "A conta do personagem destinatário receberá as <b>".$coinName."</b> e ele poderá utilizá-las no painel de usuário.";
$LANG[40008] = "Sim";
$LANG[40009] = "Não";
$LANG[40010] = "Galeria";
...
$LANG[40056] = "Suas ".strtolower($coinName_mini)." (<b>in-game</b>) serão retiradas do seu personagem e convertidas em ".strtolower($coinName_mini)." (<b>online</b>), podendo ser utilizadas para usufruir de vantagens e recursos neste painel de usuário.";
...
$LANG[30504] = "Abaixo são exibidos os clan de maior prestígio.";
...
$LANG[10030] = $coinName_mini." Ganhas";
$LANG[10031] = $coinName_mini." Bônus";
$LANG[10032] = "Total de ".$coinName_mini." a receber";
...
$LANG[10052] = "Fatura";
$LANG[10053] = "O ".$server_name." é um servidor livre de pagamento obrigatório, para que todos possam desfrutar do mundo do Lineage II gratuitamente, mas o servidor possui alguns gastos. Ao realizar uma doação, você será agraciado com uma recompensa por ter nos ajudado, e essa recompensa é um crédito exclusivo na sua conta que pode ser usado por qualquer personagem existente nela, e nós o chamamos de ".$coinName.". Com isso você estará ajudando o ".$server_name." a crescer e manter todos os seus serviços disponíveis em tempo integral.<br /><br />Esteja ciente de que nenhum item em nosso Cash Shop lhe dará status ou vantagem sobre os outros jogadores. A maioria dos nossos itens donate serão apenas cosméticos e itens de suporte para lhe fornecer uma experiência de jogo diferenciada. Este servidor é totalmente livre de P2W (Pay To Win), evitamos dar vantagens aos jogadores que contribuem com o servidor pois isso é um desrespeito com todos os outros que conseguem alcançar seus objetivos com o seu próprio esforço.";
$LANG[10054] = "Eu li e aceito os Termos de doação expressos acima";
...
$LANG[10097] = "Você não possui ".strtolower($coinName_mini)." suficientes!";
...
$LANG[10163] = "Caso queira transferir ".strtolower($coinName_mini).", preencha os campos abaixo.";
$LANG[10165] = "Quantidade de ".strtolower($coinName_mini)." que será transferida.";
$LANG[10166] = "Nome do personagem que receberá as ".strtolower($coinName_mini).".";
...
$LANG[14000] = "Termos de doação";
$LANG[14001] = "Ao doar, esteja ciente de que você não possui nenhum privilégio perante aos outros jogadores. Todos estão sujeitos às mesmas regras e punições. A quantidade de créditos que lhe será entregue não é referente a uma compra, e sim a uma recompensa por nos ajudar a manter o servidor sempre online e bem atualizado. A doação é um ato voluntário e não reembolsável financeiramente sob nenhuma circunstância.<br /><br />
Não nos responsabilizamos pela segurança e destino do crédito após ter sido entregue em sua conta. Não iremos reaver os créditos caso você os perca pelas características padrões do jogo ou por algum descuido com a segurança de sua conta.<br /><br />
Não iremos, em hipótese alguma, reembolsar o dinheiro da doação, entretanto, garantimos a entrega da recompensa na sua conta dentro dos prazos e condições estabelecidos à seguir.<br /><br />
<b>Prazos e Entrega</b><br /><br />
O prazo para a entrega varia de acordo com a forma de pagamento escolhida, podendo ser de poucos minutos para doações feitas através de transferência online ou cartão de crédito, ou até 72h para doações feitas através de boleto bancário.<br /><br />
