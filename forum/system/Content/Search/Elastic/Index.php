...
class _Index extends \IPS\Content\Search\Index
{
	...
	public function updateViewCounts( $class, $id, $count )
	{
		...
		$this->url->setPath( $this->url->data[ \IPS\Http\Url::COMPONENT_PATH ] . '/content/_update_by_query' )->setQueryString( 'conflicts', 'proceed' )->request( \IPS\LONG_REQUEST_TIMEOUT )->setHeaders( array( 'Content-Type' => 'application/json' ) )->post( json_encode( array(
			'script'	=> array(
