...
$form->add( new \IPS\Helpers\Form\YesNo( 'onlineIndicator_inName', \IPS\Settings::i()->onlineIndicator_inName, FALSE, array('togglesOn' => array( 'onlineIndicator_iconOnline', 'onlineIndicator_inName_offline', 'onlineIndicator_inName_size', 'onlineIndicator_inName_before'  )), NULL, NULL, NULL, NULL ) );
