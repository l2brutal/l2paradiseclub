...
namespace IPS\invite\extensions\core\MemberSync;
...
class _Invite
{
	...
	{
		\IPS\Db::i()->delete( 'invite_invites', array( 'invite_sender_id=?', $member->member_id ) );
		\IPS\Db::i()->delete( 'invite_invites', array( 'invite_conv_member_id=?', $member->member_id ) );
	}
}