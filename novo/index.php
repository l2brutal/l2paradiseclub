      ...
      <div class="container">
          ...
          <div class="col-md-3">
            ...
            <h3 class="titulosPrincipais">
              ...
              <div class="col-md-12 statusServer">
                <h4>Login Server</h4>
                <?php
                  ini_set( "display_errors", 0);
                  $sock=@fsockopen('149.56.79.107', '2106', $errNo, $errStr, 3);//timeout set to 3 seconds
                  if($sock){
                     fclose($sock);
                     echo "<p class=verde>• ONLINE</p>";
                  }else{
                    echo "<p class=vermelho>• OFFLINE</p>";
                  }
                ?>
              </div>
              <div class="col-md-12 statusServer">
                ...
                <?php
                  ini_set( "display_errors", 0);
                  $sock=@fsockopen('149.56.79.107', '7777', $errNo, $errStr, 3);//timeout set to 3 seconds
                  if($sock){
                     fclose($sock);
                     echo "<p class=verde>• ONLINE</p>";
                  }else{
          ...
          <div class="col-md-9 controladorEsquerda">
            ...
            <div class="chamadaPrincipal sombra">
              <div class="titulodestaque">EVENTO DE RE-LANÇAMENTO</div>
              ...
              <div class="col-md-7 textoChamadaPrincipal">
                <p>Inicialmente pedimos desculpa pela demora na reabertura. Para comemorar a reabertura do servidor nas primeiras semanas do servidor vai estar disponível um evento para ajudar os novos e os antigos players. Agora você poderá dropar PREMIUM COINS dos mobs e com elas trocar por 1 dia, 3, 7, 15 e até 30 dias com todas as mordomias de uma conta PREMIUM. E ainda, liberamos as COINS para que você comprar e vender.</p>
              </div>
            </div>
           ...
           <div class="chamadaPrincipal noticias">
            ...
            <div class="col-md-12 noticia sombra">
              <div class="col-md-4 imagemNoticia"><img src="img/chamadaPrincipal2.png" class="img-responsive"></div>
              <div class="col-md-8 textoNoticia">
                <h4>Canais de comunicação</h4>
                <p>Com o relançamento do servidor, recriamos os canais de comunicação. Muito do que falaremos sobre o servidor, seja, avisos, notícias ou modificações. Tudo será postado em nosso Fórum. Clique no botão abaixo e conheça mais.</p>
                <a href="">+ visitar o Fórum</a>
              </div>
            </div>

            <div class="col-md-12 noticia sombra">
              <div class="col-md-4 imagemNoticia"><img src="img/chamadaPrincipal3.png" class="img-responsive"></div>
              <div class="col-md-8 textoNoticia">
                <h4>Relançamento do Ultima L2</h4>
                <p>Recriamos o servidor para uma melhor experiência a jogadores que gostam de Lineage II no modo original. Junto com o servidor, estamos relançando um novo website. Confira mais no fórum tudo sobre essa nova versão.</p>
            ...
            <div class="col-md-12 siege sombra">
              ...
              <?php include "script.php"; ?>
                             ...
                             <div class="col-md-6 cSiege">
                               ...
                               <div class="col-md-8">
                                 <h4>Gludio Castle</h4>
                                 <p>Próxima siege: <span><?php echo  ucwords(utf8_encode( strftime("%d %B de %Y %H:%M", $retorno->sdate))); ?></span></p>
